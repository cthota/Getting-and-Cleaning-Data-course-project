...
•tidy data.txt The text file contains the required tidy dataset for submission. 
...
•README.md The README file for this repo.# Getting-and-Cleaning-Data-course-project